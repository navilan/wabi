...
# iPad on the left
if [ "$ND" -eq 4 ]; then D1=$d2; D2=$d2; D3=$d3; D4=$d1; D5=$d4; echo "Balancing spaces: displays=$ND [$D1, $D2, $D3, $D4 $D5]"; fi
...
sh $CDIR/wp.sh
yabai -m space --focus s7  && yabai -m space --display $D5 # Untagged
sh $CDIR/wp.sh
