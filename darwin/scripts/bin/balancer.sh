...
sh $CDIR/wp.sh
yabai -m space --focus s6  && yabai -m space --display $D2 # kitty
sh $CDIR/wp.sh
yabai -m space --focus s5  && yabai -m space --display $D2 # Safari
sh $CDIR/wp.sh
yabai -m space --focus s4  && yabai -m space --display $D2 # Chrome
sh $CDIR/wp.sh
yabai -m space --focus s3  && yabai -m space --display $D1
sh $CDIR/wp.sh
yabai -m space --focus s2  && yabai -m space --display $D1 # VSCode
sh $CDIR/wp.sh
